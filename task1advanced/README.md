...
7. Через output Terraform выводит сгенерированные значения объектов облака, которые могут портебоваться для ручной настройки или их можно переиспользовать при вызове модуля, например, ip-адреса или id подсети вот так:
